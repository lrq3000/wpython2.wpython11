...
typedef enum _expr_const { no_const=1, dummy_1=2, mutable_const=3, dummy_2=4,
                           dummy_3=5, dummy_4=6, content_const=7, dummy_5=8,
                           dummy_6=9, dummy_7=10, dummy_8=11, dummy_9=12,
                           dummy_10=13, dummy_11=14, pure_const=15 }
                           expr_const_ty;
...
expr_ty _Py_Const(object c, expr_const_ty constant, int lineno, int col_offset,
                  PyArena *arena);
